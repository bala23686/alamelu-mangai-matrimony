...
class UserBasicInfoResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            "adhard_card_image" => $this->adhard_card_image,
            "adhard_card_image_is_uploaded" => $this->adhard_card_image_is_uploaded,
            "medical_certificate " => $this->medical_certificate,
            "medical_certificate_uploaded_on" => $this->medical_certificate_uploaded_on,
            "tenth_marksheet" => $this->tenth_marksheet,
            "tenth_mark_sheet_uploaded" => $this->tenth_mark_sheet_uploaded,
            "twelth_marksheet" => $this->twelth_marksheet,
            "twelth_mark_sheet_uploaded " => $this->twelth_mark_sheet_uploaded,
            "clg_tc" => $this->clg_tc,
            "clg_tc_is_uploaded" => $this->clg_tc_is_uploaded,
