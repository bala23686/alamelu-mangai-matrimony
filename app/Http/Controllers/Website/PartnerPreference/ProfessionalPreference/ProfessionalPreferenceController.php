...
namespace App\Http\Controllers\Website\PartnerPreference\ProfessionalPreference;
...
class ProfessionalPreferenceController extends Controller
{
    ...
    public function update(ProfessionalPreferenceDetailsRequest $request, ProfessionalPreferenceUpdateServices $service, $id)
    {
        return $service->HandleProfessionalPreferenceUpdate($request, $id)
            ? response()->json(['message' => 'Partner Professional Preference Details updated'], 200)
