...
namespace App\Http\Controllers\Website\Profile\NativeDetails;
...
class NativeDetailsController extends Controller
{
    /**
    ...
    public function update(NativeInfoRequest $request, NativeInfoUpdateServices $service, $id)
    {
        return $service->HandleNativeDetailsUpdate($request, $id)
            ? response()->json(['message' => 'Native Information Successfully updated'], 200)
