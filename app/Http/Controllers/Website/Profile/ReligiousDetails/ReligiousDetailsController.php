...
namespace App\Http\Controllers\Website\Profile\ReligiousDetails;
...
class ReligiousDetailsController extends Controller
{
    /**
    ...
    public function update(ReligiousDetailsRequest $request, ReligiousDetailsUpdateServices $service, $id)
    {
        return $service->HandleReligiousDetailsUpdate($request, $id)
            ? response()->json(['message' => 'Religious Information Successfully Updated'], 200)
