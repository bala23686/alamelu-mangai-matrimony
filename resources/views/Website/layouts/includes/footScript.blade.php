...
<script src="{{ asset('web/js/slider.js') }}" async></script>
<script src="{{ asset('web/js/count-up.min.js') }}"></script>
<script src="{{ asset('web/js/validation.js') }}" defer></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/js/toastr.min.js" defer></script>
<script src="https://cdn.jsdelivr.net/npm/bootstrap-toaster@5.1.0/js/bootstrap-toaster.min.js" defer></script>
