    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-4 align-middle col-xs-offset-2">
                ...
                <img width="75%" {{-- @if (!empty($userBasicInfo->image_with_path)) src="{{ $userBasicInfo->image_with_path }}" @else --}} src="https://www.kindpng.com/picc/m/207-2074624_white-gray-circle-avatar-png-transparent-png.png" {{-- @endif  --}} alt="Preview">
            </div>

            <div class="col-xs-6">
                <h3 class="">{{ $userInfo->user_profile_id }}</h3>
                <h4><span class="text-dark">I'm</span>
                    {{ $userBasicInfo->user_full_name }}
                </h4>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <img src="{{ $UserHoroscopeInfo->user_jathakam_image }}" class="card-img-top w-50 rounded">
                    </a>
                </div>
                @endif --}}
            </div>
